...
Runtime 已收口。当前产品阶段是 **农批 AI 销售开单员 V1**：接单 / 改未确认单 / 确认为主责，今日开单本用眼睛看，不启动第二员工。规格 [V1_SALES_CLERK.md](V1_SALES_CLERK.md)；岗位评审 [SALES_EMPLOYEE_CAPABILITY.md](SALES_EMPLOYEE_CAPABILITY.md)。
