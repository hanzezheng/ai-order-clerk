...
当前阶段：不是把 ERP 逻辑放进 Runtime、不是做多 Agent、不是做平台。目标是农批 AI 销售开单员 V1 P0 今日开单本闭环（[V1_SALES_CLERK_VERTICAL_SLICE.md](V1_SALES_CLERK_VERTICAL_SLICE.md)）。只动 Demo / Workbench 呈现。ERP 读写都只经 Adapter。
