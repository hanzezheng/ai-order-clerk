...
Runtime 收口之后的**产品**阶段见 [SALES_EMPLOYEE_CAPABILITY.md](SALES_EMPLOYEE_CAPABILITY.md)。第一个可雇版本：[V1_SALES_CLERK.md](V1_SALES_CLERK.md)。用户旅程：[V1_SALES_CLERK_USER_JOURNEY.md](V1_SALES_CLERK_USER_JOURNEY.md)。工作台原型：[V1_SALES_CLERK_WORKBENCH.md](V1_SALES_CLERK_WORKBENCH.md)。垂直切片：[V1_SALES_CLERK_VERTICAL_SLICE.md](V1_SALES_CLERK_VERTICAL_SLICE.md)。Pilot：[V1_SALES_CLERK_PILOT_CHECKLIST.md](V1_SALES_CLERK_PILOT_CHECKLIST.md)。观察：[V1_SALES_CLERK_PILOT_OBSERVATION.md](V1_SALES_CLERK_PILOT_OBSERVATION.md)。数据边界：[V1_SALES_CLERK_PILOT_DATA_BOUNDARY.md](V1_SALES_CLERK_PILOT_DATA_BOUNDARY.md)。访问：[V1_SALES_CLERK_PILOT_DATA_ACCESS.md](V1_SALES_CLERK_PILOT_DATA_ACCESS.md)（Adapter 投影；Runtime 不查 ERP）。接入：[V1_SALES_CLERK_PILOT_ONBOARDING.md](V1_SALES_CLERK_PILOT_ONBOARDING.md)（空白档口到第一单）。反馈：[V1_SALES_CLERK_PILOT_FEEDBACK_LOOP.md](V1_SALES_CLERK_PILOT_FEEDBACK_LOOP.md)（明天还用则 V1.1，否则继续观察）。执行手册：[V1_SALES_CLERK_PILOT_RUNBOOK.md](V1_SALES_CLERK_PILOT_RUNBOOK.md)（第一档口当天怎么跑）。Flutter App：[V1_SALES_CLERK_FLUTTER_APP.md](V1_SALES_CLERK_FLUTTER_APP.md)（老板手机壳；只调现有 HTTP）。端侧听写：[V1_SALES_CLERK_CHINA_ASR.md](V1_SALES_CLERK_CHINA_ASR.md)。ROADMAP 阶段 2 的库存/付款/采购仍另批。
