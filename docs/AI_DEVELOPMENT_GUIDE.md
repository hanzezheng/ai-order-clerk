...
当前阶段：不是把 ERP 逻辑放进 Runtime、不是做多 Agent、不是做平台。目标是农批 AI 销售开单员 V1 Pilot 接入（[V1_SALES_CLERK_PILOT_ONBOARDING.md](V1_SALES_CLERK_PILOT_ONBOARDING.md)）：空白档口到第一单，不实施 CRM/ERP。ERP 读写都只经 Adapter。
