...
Runtime 收口之后的**产品**阶段见 [SALES_EMPLOYEE_CAPABILITY.md](SALES_EMPLOYEE_CAPABILITY.md)。第一个可雇版本：[V1_SALES_CLERK.md](V1_SALES_CLERK.md)（农批 AI 销售开单员 V1：喊单进账 + 今日开单本；不做收款/库存/第二员工）。ROADMAP 阶段 2 的库存/付款/采购仍另批。
