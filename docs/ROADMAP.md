...
Runtime 收口之后的**产品**阶段见 [SALES_EMPLOYEE_CAPABILITY.md](SALES_EMPLOYEE_CAPABILITY.md)。第一个可雇版本：[V1_SALES_CLERK.md](V1_SALES_CLERK.md)。用户旅程：[V1_SALES_CLERK_USER_JOURNEY.md](V1_SALES_CLERK_USER_JOURNEY.md)。工作台原型：[V1_SALES_CLERK_WORKBENCH.md](V1_SALES_CLERK_WORKBENCH.md)（今日开单本 = 销售员工工作台，不是 ERP / 聊天 / 报表）。ROADMAP 阶段 2 的库存/付款/采购仍另批。
